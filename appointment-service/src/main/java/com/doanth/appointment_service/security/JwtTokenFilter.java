...
//        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        ...
        try {
            Claims claims = authServiceClient.validateAccessToken(token);
            User userDetails = getUserDetails(claims);
...
//            filterChain.doFilter(request, response);
    ...
    private void setAuthenticationContext(User userDetails, HttpServletRequest request) {
