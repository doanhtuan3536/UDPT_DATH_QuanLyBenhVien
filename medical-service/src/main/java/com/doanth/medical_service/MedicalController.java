...
import com.doanth.medical_service.dto.ExaminationDTO;
import com.doanth.medical_service.dto.MedicalRecordFullDTO;
import com.doanth.medical_service.dto.MedicalRecordShortDTO;
...
public class MedicalController {
    ...
    public MedicalController(MedicalRecordService medicalRecordService, ModelMapper modelMapper, AuthServiceClient authServiceClient) {
...
//        medicalRecordShortDTO.setDoctorName(doctorInfoDTO.getHoten());
    ...
    public ResponseEntity<?> medicalRecordDetails(@PathVariable("id") Integer medicalRecordId) throws JwtValidationException {
        ...
        medicalRecordfullDTO.setDoctorName(doctorInfoDTO.getHoten());
        if(medicalRecordfullDTO.getExaminations() != null) {
            for (ExaminationDTO examination : medicalRecordfullDTO.getExaminations()) {
                examination.setDoctorName(authServiceClient.getDoctorInfo(examination.getDoctorId(), accessToken).getHoten());
            }
        }
