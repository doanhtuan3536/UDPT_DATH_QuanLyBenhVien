    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        auth -> auth.requestMatchers(HttpMethod.GET,"/api/medical/records/*")
                                ...
                                .hasAnyAuthority("benhnhan", "bacsi", "nhanvien")
                                .requestMatchers(HttpMethod.POST,"/api/medical/records/add")
                                .hasAnyAuthority("bacsi", "nhanvien")
                                ...
                                .hasAnyAuthority("bacsi", "nhanvien")
                                .requestMatchers(HttpMethod.GET,"/api/medical/medicines/categories")
                                .permitAll()
                                .requestMatchers(HttpMethod.GET,"/api/medical/medicines")
                                .permitAll()
