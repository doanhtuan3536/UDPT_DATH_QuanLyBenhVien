...
public class SignupForm {
        ...
        @Pattern(regexp = "^(\\+\\d{1,3}( )?)?\\d{10}$",
                message = "Định dạng số điện thoại sai")
        private String sdt;
        ...
        public @NotBlank(message = "Số điện thoại không được để trống") @Pattern(regexp = "^(\\+\\d{1,3}( )?)?\\d{10}$",
                message = "Định dạng số điện thoại sai") String getSdt() {
                return sdt;
        }

        public void setSdt(@NotBlank(message = "Số điện thoại không được để trống") @Pattern(regexp = "^(\\+\\d{1,3}( )?)?\\d{10}$",
                message = "Định dạng số điện thoại sai") String sdt) {
                this.sdt = sdt;
        }
